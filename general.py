...
pdf fayllar bilan ishlovchi dastur

Created on Mon May  8 14:39:23 2023
...
# -*- coding: utf-8 -*-
"""
Created on Mon May  8 14:59:33 2023
...
"""
Adding a simple colored text on a PDF page.
...
canvas.save()
Adding a simple image of a cat on a PDF page.
...
"""
Creating a simple image to store personal information on a PDF page.
...
Highlighting a word Recommender on the PDF page." height="400px
...
"""
Creating a simple form to collect personal information.
...
"""
Filling a PDF form directly through the code.
...
Logo that we are using as watermark.
...
DOI line is treated as an watermark to remove.

After the above coding implementations, the watermark is removed and the PDF appears as follows:

DOI line is completely removed from the PDF pages.
...
"""
First name of the author is something we want to replace.
...
The first name of the author has been replaced from Dominik to John.
...
The metadata information is extracted.
...
The metadata information is replaced and added.
